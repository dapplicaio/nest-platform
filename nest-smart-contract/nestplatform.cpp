...
//
void nestplatform::createlboard(eosio::name owner, string boardname, uint64_t gameid)
{
...
extern "C" void apply(uint64_t receiver, uint64_t code, uint64_t action)
{
    if (code == receiver)
    {
        switch (action)
        {
            EOSIO_DISPATCH_HELPER(nestplatform, (createlboard)(createprize)(resetlboard)(removelboard)(update)
